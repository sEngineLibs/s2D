...
class Main {
	public static function main() {
		...
		S2D.setup = function() {
			...
			sprite1.transformation.translate(-1.0, -1.0, -0.5);
			...
			sprite2.transformation.translate(0.5, 0.5, 0.5);
			...
			Compositor.dof.focusDistance = 0.0;
			Compositor.dof.fStop = 112.0;

			Scheduler.addTimeTask(function() {
				var d = Math.sin(System.time) + 1.0;
				sprite2.transformation.translationZ = d;
			}, 0, 1 / 165);
		}
