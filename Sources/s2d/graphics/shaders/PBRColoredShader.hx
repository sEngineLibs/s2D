...
class PBRColoredShader extends Shader {
	...
	override inline function getUniforms() {
		...
		ormCL = pipeline.getConstantLocation("ormCol");
	...
	override inline function setUniforms(target:Canvas, ?uniforms:Dynamic) {
		...
		target.g4.setFloat3(ormCL, uniforms[10], uniforms[11], uniforms[12]);

		var lights:Array<Light> = cast uniforms[13];
